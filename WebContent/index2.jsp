	...
	function next(){
		if(select == "*"){
			...
			if(num==5){
				...
				document.getElementById("leftpic").src = imgL;
				//document.getElementById("a_left1.leftpic").src=imgL;
				//document.getElementById("mother").src=imgR ;
				document.getElementById("rightpic").src=imgR ;
				//document.write("<h2>ASDFASFDASDFSADFADS")
				//document.write(imgR);
				//var test=document.getElementById("mother");
				//console(test);
...
<div id="wrapper">
	<!-- logo -->
		...
		<section id="question" class="main">
			<script> document.getElementById("question").innerHTML = ques1; </script> 
		</section>
		<!-- answer -->
		<section class="main items">
		
		<div class="item">
			<button onClick="left_click()" style="display:contents">
				<header><a id="a_left1"><img id="leftpic" src="image/TR/TR_q1_L.jpg"/></a>
			</header></button>
			<p id="left">오늘은 자극적인 음식이 안땡겨..</p>
		</div>
		<article class="item" onClick="right_click()">
				 <img id="rightpic" src="image/TR/TR_q1_R.jpg"/>
